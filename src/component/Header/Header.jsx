...
const Header = (props) => {
    console.log(props.selectMeal.length)
            ...
            <div className="navbar px-20">
                ...
                <div className="navbar-end">
                    ...
                    <button className='focus:text-gray-300 relative input-field transition-all ' title='Search with your text,letter, country, foods'>                      
                            <input type="text" placeholder="Search with first latter" id='search-input' className="search-input input input-primary h-[40px] relative transition-all bg-transparent" />
                    ...
                    <button className="btn btn-ghost btn-circle">
                        <div className="indicator">
                            ...
                            <span id='badge' className="badge badge-xs badge-primary indicator-item w-5 h-4 text-[13px] ">{props.selectMeal.length?props.selectMeal.length:0}</span>
                        </div>
                    </button>
                </div>
            </div>
